...
9. Docs-first + DD / TDD process + smoke / E2E enforcement for coding tasks — write or fix docs before any code (feature or test); modularize & extract shared code (no copy-paste, high cohesion / low coupling); docs-after — once all required tests/checks pass, sync any stale/inaccurate docs
